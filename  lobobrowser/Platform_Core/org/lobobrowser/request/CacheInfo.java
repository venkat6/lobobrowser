...
public class CacheInfo {
	...
	/**
	 * This method should only be called if the connection
	 * is later going to be closed.
	 */
	...
	/**
	 * This method should be called when the CacheInfo instance is no longer needed
	...
	/**
	 * Adds the request time of the cached document to the
	 * given offset.
	 */
	...
	/**
	 * Gets the timestamp when the cache entry should expire
	 * and must be revalidated. If <code>null</code>, the
	 * browser can use a default. When the entry must be
	 * revalidated, this method returns zero.
	 */
