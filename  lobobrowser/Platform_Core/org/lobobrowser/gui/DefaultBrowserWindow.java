...
public class DefaultBrowserWindow extends AbstractBrowserWindow {
	...
	public DefaultBrowserWindow(boolean hasMenuBar, boolean hasAddressBar, boolean hasToolBar, boolean hasStatusBar, NavigatorWindowImpl windowContext) throws HeadlessException {
		//TODO: SECURITY: Security needed in this class to prevent removal of all window components??
...
//				Collection<JMenuItem> sharedMenuItems = windowContext.getSharedMenuItems();
...
//		if(lastDbSize == null || lastDbSize.width != size.width || lastDbSize.height != size.height) {
...
//		g.drawImage(dbi, 0, 0, size.width, size.height, clipBounds.x, clipBounds.y, clipBounds.width, clipBounds.height, this);
	}
}
