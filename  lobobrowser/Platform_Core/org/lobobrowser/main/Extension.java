...
public class Extension implements Comparable, NavigatorExtensionContext {
	...
	/**
	 * The highest priority, only available to the
	 * default platform extension.
	 */
	public static final int PRIMARY_EXTENSION_PRIORITY = 10;

	/**
	 * The highest priority allowed for non-primary
	 * platform extensions.
	 */
	...
	/**
	 * Gets the {@link org.lobobrowser.ua.NavigatorExtension} implementation.
	 * It may return <code>null</code> in the case
	 * of a library.
	 */
