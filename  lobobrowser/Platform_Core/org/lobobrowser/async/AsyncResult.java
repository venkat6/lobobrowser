...
/**
 * Used by methods that need to return results asynchronously. Results
 * are received in the event dispatch thread.
 * This is a generic class that takes a type parameter <code>TResult</code>,
 * the type of the expected result object.
 * @author J. H. S.
 */
