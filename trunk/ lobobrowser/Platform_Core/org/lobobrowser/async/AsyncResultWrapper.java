...
public class AsyncResultWrapper<TResult> implements AsyncResult<TResult>,AsyncResultListener<TResult> {
	...
	/* (non-Javadoc)
	 * @see org.xamjwg.clientlet.AsyncResult#addResultListener(org.xamjwg.clientlet.AsyncResultListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xamjwg.clientlet.AsyncResult#removeResultListener(org.xamjwg.clientlet.AsyncResultListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xamjwg.clientlet.AsyncResultListener#exceptionReceived(org.xamjwg.clientlet.AsyncResultEvent)
	 */
	public void exceptionReceived(AsyncResultEvent<Throwable> event) {
		AsyncResultListener[] listenersArray;
		synchronized(this) {
			listenersArray = (AsyncResultListener[]) this.listeners.toArray(new AsyncResultListener[0]);
		}
	...
	/* (non-Javadoc)
	 * @see org.xamjwg.clientlet.AsyncResultListener#resultReceived(org.xamjwg.clientlet.AsyncResultEvent)
	 */
