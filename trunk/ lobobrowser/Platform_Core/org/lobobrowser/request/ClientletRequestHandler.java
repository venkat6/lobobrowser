...
public class ClientletRequestHandler extends AbstractRequestHandler {
	...
	/**
	 * For progress events, but a null event is also fired
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.xamj.http.RequestHandler#processResponse(org.xamjwg.dom.ClientletResponse)
	 */
	public void processResponse(final ClientletResponse response)
		...
		ThreadGroup newThreadGroup = null; //new org.lobobrowser.context.ClientletThreadGroupImpl("CTG-" + ctx.getResponse().getResponseURL().getHost(), ctx);
