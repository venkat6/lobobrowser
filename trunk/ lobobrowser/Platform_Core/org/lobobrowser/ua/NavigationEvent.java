...
public class NavigationEvent extends java.util.EventObject {
	...
	public NavigationEvent(Object source, URL url, String method, ParameterInfo paramInfo, TargetType targetType, RequestType requestType, NavigatorFrame originatingFrame) {
		this(source, url, method, paramInfo, targetType, requestType, false, null, originatingFrame);
	}

	public NavigationEvent(Object source, URL url, TargetType targetType, RequestType requestType, Object linkObject, NavigatorFrame originatingFrame) {
