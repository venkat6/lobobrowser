...
/**
 * Whenever {@link FramePanel} is used, browser windows 
 * should implement this interface
 * or extend {@link AbstractBrowserWindow}. 
 * Note that {@link BrowserPanel} implements this
 * interface already, so it is not necessary to
 * have windows implement it when <code>BrowserPanel</code>
 * is used.
 */
